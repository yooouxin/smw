...
enum ServiceDiscovery_ServiceDiscoveryOperation : int {
  ...
  ServiceDiscovery_ServiceDiscoveryOperation_ServiceDiscovery_ServiceDiscoveryOperation_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ServiceDiscovery_ServiceDiscoveryOperation_ServiceDiscovery_ServiceDiscoveryOperation_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class ServiceDiscovery final :
 ...
 public:
  ...
  inline ServiceDiscovery* New() const final {
    return new ServiceDiscovery();
  }

  ServiceDiscovery* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT ::smw::core::proto::ServiceInfo* release_service_info();
